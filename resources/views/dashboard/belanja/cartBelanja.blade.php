...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <a href="/belanja" style="text-decoration: none"><i class="fa-sharp fa-solid fa-chevron-left mt-4 mr-2"></i>kembali</a>
    ...
    <div class="row">
        <div class="col-lg-7 m-3 pl-5">
            <table class="table table-bordered text-center mb-0">
                ...
                <tbody class="align-middle">
                    ...
                    <tr>
                        <td>{{ $c->nama_produk }}</td>
                        <td>Rp {{ $c->harga_beli }}</td>
                        <td>
                            <div class="input-group quantity mx-auto" style="width: 100px;">
                                <div class="input-group-btn">
                                    <form method="POST" action="{{ route('cartBelanja.change', ['id' => $c->id]) }}">
                                        @csrf
                                        @method('PUT')
                        ...
                        <td class="align-middle">
                            <form method="POST" action="{{ route('cartBelanja.destroy', ['id' => $c->id]) }}">
                                @csrf
                                @method('DELETE')
        ...
        <div class="col-lg-4 m-3">
            <div class="card border-secondary mb-5">
                ...
                <form method="POST" action="{{ route('belanja.process') }}">
                    @csrf
                    @method('PUT')
